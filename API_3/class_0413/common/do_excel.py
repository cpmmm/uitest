...
'''
import openpyxl
from API_3.class_0413.common import contants

from API_3.class_0413.common import http_request

from API_3.class_0413.common import http_request2
class Case:
    '''
...
if __name__ == '__main__':
    do_excel=DoExcel(contants.case_file,sheet_name='TestLogin')
    cases=do_excel.get_case()
    http_request = http_request2.HTTPRequest2()
    for case in cases:
        # print(case.case_id)
        # print(case.title)
        # print(case.url)
